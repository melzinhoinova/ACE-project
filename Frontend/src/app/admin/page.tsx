...
export default function AdminPage() {
  ...
  // Lista local de convites emitidos (persiste em localStorage)
    ...
    <TopBar>
      <main className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs font-semibold text-primary">
              <ShieldCheck size={14} /> Módulo Restrito · Administração
            </div>
            <h1 className="mt-3 text-3xl font-extrabold tracking-tight sm:text-4xl">
              Gestão de <span className="text-gradient-brand">Acessos & Convites</span>
            </h1>
            <p className="mt-1 text-sm text-muted-foreground">
              Como esta é uma plataforma B2B privada, gerencie e convide novas marcas para acessar o ACE Studio.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-12">
            ...
            <div className="rounded-3xl border border-border/60 bg-card p-6 shadow-card">
              <div className="flex items-center gap-3 pb-4 border-b border-border/40">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Envie um link de onboarding</p>
                </div>
              </div>
              ...
              <form onSubmit={handleSendInvite} className="mt-6 space-y-4">
                ...
                <div>
                  ...
                  >
                    <option value="Brand Manager">Gestor de Marca (Padrão)</option>
          ...
          {/* Lista de Convites e Membros Ativos */}
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="rounded-2xl border border-border/60 bg-card p-4 text-center">
                ...
                <div className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider mt-1">Ativos</div>
              </div>
              <div className="rounded-2xl border border-border/60 bg-card p-4 text-center">
            ...
            <div className="rounded-3xl border border-border/60 bg-card p-6 shadow-card">
              <div className="flex items-center justify-between pb-4 border-b border-border/40">
                <div className="flex items-center gap-2 font-bold text-base">
                  <Users size={18} className="text-brand" /> Registro de Marcas Convidadas
                </div>
                <span className="text-xs text-muted-foreground">{convites.length} cadastros</span>
              </div>
