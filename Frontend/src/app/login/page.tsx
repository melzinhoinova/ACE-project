...
import { LucideRocket, Mail, Lock, Loader2, ArrowRight } from "lucide-react";
      ...
      <div className="w-full max-w-md space-y-8 z-10">
        ...
        <div className="text-center space-y-3">
          ...
          <h2 className="text-3xl font-extrabold tracking-tight">
            Entrar no <span className="text-gradient-brand">ACE</span>
          </h2>
        ...
        <div className="rounded-3xl border border-border/50 bg-card/60 backdrop-blur-md p-8 shadow-xl">
          ...
          <div className="mt-8 pt-6 border-t border-border/30 text-center text-xs text-muted-foreground">
            ...
            <Link href="/cadastro" className="font-bold text-brand hover:underline transition">
              Criar Conta
            </Link>
          </div>
        </div>
